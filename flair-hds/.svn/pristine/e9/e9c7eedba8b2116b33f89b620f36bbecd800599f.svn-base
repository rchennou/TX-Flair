    ...
    */
    class HoughLines : public core::IODevice {
        public:
            ...
            */
            HoughLines(const core::IODevice* parent,const gui::LayoutPosition* position,std::string name,const core::Vector2D *ptRefGlobal=NULL,float thetaRefGlobal=0);
