...
static const char qt_meta_stringdata_DoubleSpinBox[] = {
    "DoubleSpinBox\0\0value\0valuechanged(QString)\0"
};
...
const QMetaObjectExtraData DoubleSpinBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DoubleSpinBox::staticMetaObject = {
    { &FormLayout::staticMetaObject, qt_meta_stringdata_DoubleSpinBox,
      qt_meta_data_DoubleSpinBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DoubleSpinBox::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DoubleSpinBox))
